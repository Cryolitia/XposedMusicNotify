...
public class System {
    public static void ExpandNotificationsHook(XC_LoadPackage.LoadPackageParam paramLoadPackageParam) {
        XposedHelpers.findAndHookMethod("com.android.systemui.statusbar.phone.StatusBar", paramLoadPackageParam.classLoader, "updateRowStates", new XC_MethodHook() {
